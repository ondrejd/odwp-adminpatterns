...
class Screen_JqueryUi extends Screen_Prototype {
    ...
    public function __construct( $options = array() ) {
        ...
        $options['menu_title'] = __( 'jQuery UI', ODWPAP_DOMAIN );
        $options['page_title'] = __( 'jQuery UI Components', ODWPAP_DOMAIN );
	    $options['page_description'] = sprintf( __( 'Page with all components of %sjQuery UI%s rendered with snippets.', ODWPAP_DOMAIN ), '<strong>', '</strong>' );
